...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{url('/subcategory/subcategory')}}">View Subcategory</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::open(['url' => '/subcategory/subcategory', 'files' => true]) !!}
                        @include ('subcategory.subcategory.form')
                        {!! Form::close() !!}
                       </div>
                  </div>
              </div>
