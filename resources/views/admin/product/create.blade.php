@extends('layouts.app')
@push('before-css')
      <!--<link rel="stylesheet" href="{{asset('css/docsupport/style.css')}}">-->
          ...
          <div class="col-md-7">
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['enctype' => 'multipart/form-data', 'url' => '/admin/product', 'files' => true, 'id' => 'myDropzone', 'class' => 'dropzone']) !!}
...
@push('js')
  ...
  <script src="{{asset('css/docsupport/prism.js')}}" type="text/javascript" charset="utf-8"></script>
