                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered">
                                <tbody>
                                    ...
                                    <tr><th>Name </th><td> {{ $inquiry->fname }} </td></tr>
                                    ...
                                    @endif
                                    @if( $inquiry->last_company != null)
                                    <tr><th> Class </th><td> {{ $inquiry->last_company }} </td></tr>
                                    @endif
                                    @if( $inquiry->notes != null)
                                    <tr><th> Notes </th><td> {{ $inquiry->notes }} </td></tr>
                                    @endif
                                    @if( $inquiry->model != null)
                                    <tr><th> Model of Machine </th><td> {{ $inquiry->model }} </td></tr>
                                    @endif
                                    @if( $inquiry->shipping_address != null)
                                    <tr><th> Shipping Address </th><td> {{ $inquiry->shipping_address }} </td></tr>
                                    @endif
                            </table>
                        </div>
                    </div>
