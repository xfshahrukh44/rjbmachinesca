                    ...
                    <div class="mt-4">
                        ...
                        <div class="text-95 text-secondary-d3">
                            ...
                            <div class="row mb-2 mb-sm-0 py-25">
                                ...
                                <div class="d-none d-sm-block col-2 text-95">${{ number_format($order_product->order_products_price) }}</div>
                                <div class="col-2 text-secondary-d2">${{ number_format($order_product->order_products_subtotal) }}</div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                <div class="row my-2">
                                    ...
                                    <div class="col-5">
                                        <span class="text-120 text-secondary-d1">${{ number_format($subtotal) }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                    ...
                                    <div class="col-5">
                                        ...
                                        ?>
                                        <span class="text-150 text-success-d3 opacity-2">${{ number_format($order->order_total  + $shipping) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
