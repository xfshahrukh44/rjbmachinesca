...
class AdminController extends Controller
{
	...
	public function logoUpload(Request $request) {
			...
			$validArr = array();
			if($request->file('image')) {
				$validArr['image'] = 'required|mimes:jpeg,jpg,png,gif,webp|required|max:10000';
			}
	...
	public function contactSubmissions() {
	 	$contact_inquiries = DB::table('inquiry')->where('type', 1)->get();

	 	return view('admin.inquires.contact_inquiries', compact('contact_inquiries'));

	}

    public function productInquirySubmissions() {
        $contact_inquiries = DB::table('inquiry')->where('type', 2)->get();
